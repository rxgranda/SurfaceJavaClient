 ...
 */
public class MTBlobInputEvt extends AbstractCursorInputEvt {
	 ...
	 * @param m the m
	 */
	public MTBlobInputEvt(AbstractInputSource source, 
			float positionX,
			float positionY, 
			int id,
			InputCursor m,
		...
		this(source, positionX, positionY, id, m, blob_id, 0, 0, 0, 0, 0, 0,new ArrayList<TuioPoint>());
	...
	public Object clone() throws CloneNotSupportedException {
		return new MTBlobInputEvt((AbstractInputSource) this.getSource(), this.getX(), this.getY(), this.getId(), this.getCursor(), this.getBlobId(), this.getAngle(), this.getX_speed(), this.getY_speed(), this.getR_speed(), this.getM_accel(), this.getR_accel(),this.getPuntos());
	}
